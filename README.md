...
6. Le module stocke le payload brut et normalise les lignes, sans modifier la commande depuis le retour public.
7. L'utilisateur confirme l'import depuis `public/import.php`, avec authentification Dolibarr et token CSRF.
8. Le module crée ou retrouve les produits, met à jour les prix fournisseur et ajoute les lignes dans la commande.
...
Les pages publiques vérifient le jeton Punchout et l'entité. L'import reste protégé par authentification Dolibarr et token CSRF.
